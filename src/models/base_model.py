...
class BaseModel(nn.Module):
    ...
    def __init__(self, yamada_model=None, gram_embs=None, args=None):
        ...
        self.word_embs = nn.Embedding(yamada_model['word_embs'].shape[0], yamada_model['word_embs'].shape[1], padding_idx=0, sparse=self.args.sparse)
        ...
        self.ent_embs = nn.Embedding(yamada_model['ent_embs'].shape[0], yamada_model['ent_embs'].shape[1], padding_idx=0, sparse=self.args.sparse)
