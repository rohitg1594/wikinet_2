# Yamada model that uses context and string features.
import torch
...
class YamadaContextString(YamadaBase):
    ...
    def forward(self, inputs):
        tokens, candidate_ids, exact_match, contains = inputs
        ...
        input = torch.cat((token_embs, dot_product, candidate_embs, exact_match, contains), dim=3)
