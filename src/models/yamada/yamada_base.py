...
class YamadaBase(nn.Module):
    def __init__(self, yamada_model=None, args=None):
        ...
        self.embeddings_word.weight.data.copy_(word_embs)
        ...
        self.embeddings_ent.weight.data.copy_(ent_embs)
        ...
        self.orig_linear.weight.data.copy_(W)
        self.orig_linear.bias.data.copy_(b)
