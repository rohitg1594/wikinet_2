...
def parse_args():
    ...
    model_names = ['only_prior', 'only_prior_linear', 'only_prior_full', 'only_prior_multi_linear', 'only_prior_rnn',
                   'include_word', 'include_gram', 'mention_prior', 'weigh_concat', 'only_prior_conv']
